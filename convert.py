...
if __name__ == '__main__':
    ...
    symbol, arg_params, aux_params = mx.model.load_checkpoint('mobilenet_face', 100)

    # caffe_prototxt = str(convert_symbol2proto(symbol))
    # with open('./mobilenet_face.prototxt', 'w') as prototxt_file:
    #     prototxt_file.write(caffe_prototxt)
    convert_params2model('./mobilenet_face.prototxt', './mobilenet_face.caffemodel', symbol, arg_params, aux_params)