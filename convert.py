...
if __name__ == '__main__':
    ...
    symbol, arg_params, aux_params = mx.model.load_checkpoint('model/src/resnet_v4_stage', 83)

    caffe_prototxt = str(convert_symbol2proto(symbol))
    # with open('model/dst/resnet_v4_stage.prototxt', 'w') as prototxt_file:
    #     prototxt_file.write(caffe_prototxt)
    convert_params2model('model/dst/resnet_v4_stage.prototxt', 'model/dst/resnet_v4_stage.caffemodel', symbol, arg_params, aux_params)